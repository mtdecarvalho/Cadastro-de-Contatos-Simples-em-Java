...
public class GradeCadastroPessoalJFORM extends javax.swing.JFrame {
    ...
    public GradeCadastroPessoalJFORM() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GradeCadastroPessoalJFORM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GradeCadastroPessoalJFORM().setVisible(true);
            }
        });
    }
